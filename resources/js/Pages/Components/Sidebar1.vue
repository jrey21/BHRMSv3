...
const toggleDropdown = (menu) => {
    if (menu === 'maternalCare') {
        ...
        medicalRecordsOpen.value = false;
        censusRecordsOpen.value = false;
    ...
    <nav id="sidebar" :class="{ open: sidebarOpen }">
        <div class="sidebar-content">
            <ul>
                ...
                <li>
                    <Link :href="route('dashboard')" class="menu" :class="{ active: route().current('dashboard') }">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                ...
                <hr>
                <li>
                    <Link :href="route('comprehensive-survey')" class="menu" :class="{ active: route().current('comprehensive-survey') }">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                ...
                <li>
                    <Link :href="route('childcare-form')" class="menu" :class="{ active: route().current('childcare-form') }">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path d="M720-240q25 0 42.5-17.5T780-300q0-25-17.5-42.5T720-360q-25 0-42.5 17.5T660-300q0 25 17.5 42.5T720-240Zm0 120q32 0 57-14t42-39q-20-16-45.5-23.5T720-204q-28 0-53.5 7.5T621-173q17 25 42 39t57 14Zm-520 0q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v268q-19-9-39-15.5t-41-9.5v-243H200v560h242q3 22 9.5 42t15.5 38H200Zm0-120v40-560 243-3 280Zm80-40h163q3-21 9.5-41t14.5-39H280v80Zm0-160h244q32-30 71.5-50t84.5-27v-3H280v80Zm0-160h400v-80H280v80ZM720-40q-83 0-141.5-58.5T520-240q0-83 58.5-141.5T720-440q83 0 141.5 58.5T920-240q0 83-58.5 141.5T720-40Z"/>
                        </svg>
                       ECCD Form
                ...
                <li>
                    <Link :href="route('pnea-enrollment')" class="menu" :class="{ active: route().current('pnea-enrollment') }">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                ...
                <li>
                    ...
                    <ul :class="{ 'sub-menu': true, 'show': maternalCareOpen }">
                        <li><Link :href="route('pnea-enrollment-view')" class="menu" :class="{ active: route().current('pnea-enrollment-view') }">Pregnant Women</Link></li>
                        <li><Link href="#" class="menu">Monitoring Form</Link></li>
                        <li><Link href="#" class="menu">Breastfeeding</Link></li>
                    </ul>
                </li>

                <li>
                    <Link :href="route('childcare-form-view')" class="menu" :class="{ active: route().current('childcare-form-view') }">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path d="M480-880q83 0 155.5 31.5t127 86q54.5 54.5 86 127T880-480q0 82-31.5 155t-86 127.5q-54.5 54.5-127 86T480-80q-82 0-155-31.5t-127.5-86Q143-252 111.5-325T80-480q0-83 31.5-155.5t86-127Q252-817 325-848.5T480-880Zm0 720q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Zm-80-520q0 33 23.5 56.5T480-600q33 0 56.5-23.5T560-680q0-33-23.5-56.5T480-760q-33 0-56.5 23.5T400-680Zm80 120q-53 0-116.5 26T300-460v160q0 44 63 74t137 24v-80q-35 2-66-5t-54-21q5-23 35-37.5t65-14.5q35 0 67.5 16t32.5 42v82q44-16 62-38.5t18-41.5v-160q0-48-63.5-74T480-560Zm0 180q-21 0-35.5-14.5T430-430q0-21 14.5-35.5T480-480q21 0 35.5 14.5T530-430q0 21-14.5 35.5T480-380Zm0-100Z"/>
                        </svg>
                        Child Care Data
                ...
                <li>
                    ...
                    <ul :class="{ 'sub-menu': true, 'show': medicalRecordsOpen }">
                        <li> <Link :href="route('vaccination-record')" class="menu" :class="{ active: route().current('vaccination-record') }">List of Vaccinated</Link></li>
                        <li> <Link :href="route('growth-monitoring')" class="menu" :class="{ active: route().current('growth-monitoring') }">Growth Monitoring</Link></li>
                        <li> <Link :href="route('age-grouping-view')" class="menu" :class="{ active: route().current('age-grouping-view') }">Age Grouping</Link></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul :class="{ 'sub-menu': true, 'show': censusRecordsOpen }">
                        <li> <Link :href="route('comprehensive-survey-view')" class="menu" :class="{ active: route().current('comprehensive-survey-view') }">List of Residents</Link></li>
                        <li><Link :href="route('pwd-view')" class="menu" :class="{ active: route().current('pwd-view') }">List of PWD's</Link></li>
                        <li> <Link :href="route('senior-citizen-view')" class="menu" :class="{ active: route().current('senior-citizen-view') }">List of Senior Citizen</Link></li>
                        <li><Link :href="route('four-ps-view')" class="menu" :class="{ active: route().current('four-ps-view') }">List of 4P's</Link></li>
                    </ul>
                </li>
