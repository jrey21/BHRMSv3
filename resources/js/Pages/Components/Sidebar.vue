    ...
    <nav id="sidebar" :class="{ open: sidebarOpen }">
        <div class="sidebar-content">
            <ul>
                ...
                <!-- Category -->
                <h3 v-if="$page.props.auth.user.position === 'admin'" class="categories">User Administration</h3>
                <hr v-if="$page.props.auth.user.position === 'admin'">

                <li v-if="$page.props.auth.user.position === 'admin'">
                    <Link :href="route('confirm-users')" class="menu" :class="{ active: route().current('confirm-users') }" @click="setActiveLink($event.target.closest('.menu'))">
                ...
                <li v-if="$page.props.auth.user.position === 'admin'">
                    <Link :href="route('user-management')" class="menu" :class="{ active: route().current('user-management') }" @click="setActiveLink($event.target.closest('.menu'))">
